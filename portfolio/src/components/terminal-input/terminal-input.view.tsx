import type { FormEvent, ChangeEvent, KeyboardEvent, RefObject } from "react";
...
const terminalInput = tv({
  slots: {
    ...
    label: "flex min-w-0 items-baseline gap-x-1 text-[0.9rem] leading-[1.6]",
    prompt: "shrink-0 font-medium leading-[inherit] text-neon neon-glow-soft",
    field: "relative min-w-0 flex-1",
    input:
      "relative z-1 w-full border-0 bg-transparent p-0 text-[inherit] leading-[inherit] text-text-bright caret-neon outline-none",
